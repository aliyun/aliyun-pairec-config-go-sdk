...
func FinishInt32ValueColumnBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedInt32ValueColumnBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
