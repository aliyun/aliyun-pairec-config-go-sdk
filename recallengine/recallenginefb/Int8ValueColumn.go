...
func FinishInt8ValueColumnBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedInt8ValueColumnBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
